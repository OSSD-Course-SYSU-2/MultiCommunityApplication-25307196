...
export class HotColumnView extends ViewPU {
    ...
    HotListBuilder(index: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("features/hot/src/main/ets/view/HotColumnView.ets(34:5)", "hot");
        }, List);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
                        ...
                        this.ifElseBranchUpdateFunction(0, () => {
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("features/hot/src/main/ets/view/HotColumnView.ets(37:11)", "hot");
                                };
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/hot/src/main/ets/view/HotColumnView.ets(53:5)", "hot");
            Column.width('100%');
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Swiper.create();
            Swiper.debugLine("features/hot/src/main/ets/view/HotColumnView.ets(54:7)", "hot");
