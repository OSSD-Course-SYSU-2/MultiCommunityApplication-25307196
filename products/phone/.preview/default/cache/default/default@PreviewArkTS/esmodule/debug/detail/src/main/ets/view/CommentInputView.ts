...
export class CommentInputView extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("features/detail/src/main/ets/view/CommentInputView.ets(28:5)", "detail");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextArea.create({ placeholder: { "id": 67109354, "type": 10003, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }, text: this.content });
            TextArea.debugLine("features/detail/src/main/ets/view/CommentInputView.ets(29:7)", "detail");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 67109256, "type": 20000, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
            Image.debugLine("features/detail/src/main/ets/view/CommentInputView.ets(46:7)", "detail");
