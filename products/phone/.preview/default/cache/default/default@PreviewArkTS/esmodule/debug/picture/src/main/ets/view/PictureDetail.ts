...
export class PictureDetail extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(46:5)", "picture");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(47:7)", "picture");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(48:9)", "picture");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(55:11)", "picture");
        }, GridCol);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(62:13)", "picture");
            Stack.align(Alignment.TopStart);
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Swiper.create();
            Swiper.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(63:15)", "picture");
            Swiper.autoPlay(false);
            Swiper.indicator(new DigitIndicator()
                .fontColor({ "id": 67108948, "type": 10001, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" })
                .digitFont({
                size: { "id": 67109448, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" },
                weight: FontWeight.Normal
            })
                .selectedFontColor({ "id": 67108948, "type": 10001, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" })
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(65:19)", "picture");
                    Stack.alignContent(Alignment.BottomStart);
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create(item);
                    Image.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(66:21)", "picture");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.isDetailPage && index === this.picList.length - 1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(72:23)", "picture");
                                Row.width(BaseCommon.FULL_PERCENT);
                                Row.padding({
                                    left: new BreakpointType({ "id": 67109065, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }, { "id": 67109064, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }, { "id": 67109063, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" })
                                        .getValue(this.currentBreakpoint),
                                    right: new BreakpointType({ "id": 67109065, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }, { "id": 67109064, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }, { "id": 67109063, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" })
                                        .getValue(this.currentBreakpoint)
                                });
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(73:25)", "picture");
                                Button.width({ "id": 67109435, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
                                Button.height({ "id": 67108873, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(82:25)", "picture");
                                Button.width({ "id": 67109435, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
                                Button.height({ "id": 67108873, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
        ...
        Swiper.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 67109434, "type": 20000, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
            Image.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(130:15)", "picture");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(151:11)", "picture");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isShowInput) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(171:9)", "picture");
                        Stack.alignContent(Alignment.Bottom);
                    }, Stack);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("features/picture/src/main/ets/view/PictureDetail.ets(172:11)", "picture");
