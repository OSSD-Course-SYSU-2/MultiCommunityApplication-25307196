...
class Index extends ViewPU {
            ...
            if ('rankPage' === name) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        NavDestination.debugLine("products/phone/src/main/ets/pages/MainPage.ets(35:7)", "phone");
                    }, NavDestination);
                    NavDestination.pop();
                });
            }
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        NavDestination.create(() => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("products/phone/src/main/ets/pages/MainPage.ets(41:9)", "phone");
                        ...
                        NavDestination.hideTitleBar(true);
                        NavDestination.debugLine("products/phone/src/main/ets/pages/MainPage.ets(40:7)", "phone");
                    }, NavDestination);
                    NavDestination.pop();
                });
            }
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        NavDestination.hideTitleBar(true);
                        NavDestination.debugLine("products/phone/src/main/ets/pages/MainPage.ets(49:7)", "phone");
                    }, NavDestination);
                    NavDestination.pop();
                });
            }
                ...
                this.ifElseBranchUpdateFunction(3, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        NavDestination.hideTitleBar(true);
                        NavDestination.debugLine("products/phone/src/main/ets/pages/MainPage.ets(58:7)", "phone");
                    }, NavDestination);
                    NavDestination.pop();
                });
            }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("products/phone/src/main/ets/pages/MainPage.ets(66:5)", "phone");
