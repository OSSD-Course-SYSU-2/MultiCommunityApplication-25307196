...
export class HotPointPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/hot/src/main/ets/view/HotPointPage.ets(29:5)", "hot");
            Column.padding({
                top: deviceInfo.deviceType === BaseCommon.DEVICE_2IN1 ? { "id": 67108901, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" } : { "id": 67108955, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }
            });
            Column.backgroundColor({ "id": 67108948, "type": 10001, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
            Column.height(BaseCommon.FULL_PERCENT);
            Column.justifyContent(FlexAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/hot/src/main/ets/view/HotPointPage.ets(30:7)", "hot");
            Column.height(BaseCommon.FULL_PERCENT);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isFoundSelected) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("features/hot/src/main/ets/view/HotPointPage.ets(38:11)", "hot");
