...
export class StanceVoteView extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(44:5)", "detail");
            Column.width('100%');
            Column.padding(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题
            Text.create('观点站队');
            Text.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(46:7)", "detail");
            // 标题
            Text.fontSize(14);
            // 标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 投票按钮行
            Row.create();
            Row.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(52:7)", "detail");
            // 投票按钮行
            Row.width('100%');
            // 投票按钮行
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(62:9)", "detail");
            Blank.width(12);
        }, Blank);
        Blank.pop();
        // 反对按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(73:9)", "detail");
            Blank.width(12);
        }, Blank);
        Blank.pop();
        // 中立按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.userStance !== StanceType.NONE) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(89:9)", "detail");
                        Row.width('100%');
                        Row.margin({ top: 8 });
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(90:11)", "detail");
                        Text.fontSize(12);
                        Text.fontColor('#666666');
                    }, Text);
                    Text.pop();
    ...
    StanceButton(label: string, stance: StanceType, count: number, total: number, color: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(106:5)", "detail");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel(label);
            Button.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(107:7)", "detail");
            Button.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("features/detail/src/main/ets/view/StanceVoteView.ets(122:7)", "detail");
            Text.fontSize(12);
            Text.fontColor('#666666');
            Text.margin({ top: 4 });
        }, Text);
