...
export class DetailVertical extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/picture/src/main/ets/view/DetailVerticalView.ets(27:5)", "picture");
            Column.height(BaseCommon.FULL_PERCENT);
            Column.padding({
                top: this.getPaddingTop()
            });
            Column.backgroundColor({ "id": 67109449, "type": 10001, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("features/picture/src/main/ets/view/DetailVerticalView.ets(28:7)", "picture");
            Scroll.scrollBar(BarState.Off);
            Scroll.layoutWeight(1);
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/picture/src/main/ets/view/DetailVerticalView.ets(29:9)", "picture");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            __Common__.create();
            __Common__.padding({
    ...
    getPaddingTop(): Resource {
        ...
        return { "id": 67108901, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" };
    }
    rerender() {
