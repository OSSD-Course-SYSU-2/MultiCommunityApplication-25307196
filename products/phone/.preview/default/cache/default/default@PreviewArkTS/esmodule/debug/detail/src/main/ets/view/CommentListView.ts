...
export class CommentListView extends ViewPU {
    ...
    itemHead(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("features/detail/src/main/ets/view/CommentListView.ets(38:5)", "detail");
            Row.width(BaseCommon.FULL_PERCENT);
            Row.height({ "id": 67109305, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
            Row.padding({
                top: { "id": 67109049, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }
            });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 67109353, "type": 10003, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
            Text.debugLine("features/detail/src/main/ets/view/CommentListView.ets(39:7)", "detail");
            Text.fontSize({ "id": 67109304, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/detail/src/main/ets/view/CommentListView.ets(53:5)", "detail");
            Column.justifyContent(FlexAlign.End);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Tabs.create({ barPosition: BarPosition.Start });
            Tabs.debugLine("features/detail/src/main/ets/view/CommentListView.ets(54:7)", "detail");
            Tabs.vertical(false);
            Tabs.layoutWeight(1);
            Tabs.padding({
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    List.debugLine("features/detail/src/main/ets/view/CommentListView.ets(56:11)", "detail");
                    List.nestedScroll({
                    ...
                    List.margin({
                        top: { "id": 67109338, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" }
                    });
                }, List);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    If.create();
                        ...
                        this.ifElseBranchUpdateFunction(0, () => {
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("features/detail/src/main/ets/view/CommentListView.ets(59:15)", "detail");
                                };
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    const forEachItemGenFunction = _item => {
                        const item = _item;
                        {
                            ...
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ListItem.create(deepRenderFunction, true);
                                ListItem.debugLine("features/detail/src/main/ets/view/CommentListView.ets(66:17)", "detail");
                            };
                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                itemCreation(elmtId, isInitialRender);
                                {
            ...
            TabContent.debugLine("features/detail/src/main/ets/view/CommentListView.ets(55:9)", "detail");
        }, TabContent);
        TabContent.pop();
        Tabs.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
    ...
    getPadding(): Resource {
        if (this.currentBreakpoint === Breakpoint.BREAKPOINT_SM) {
            return { "id": 67109065, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" };
        }
        if (this.currentBreakpoint === Breakpoint.BREAKPOINT_MD) {
            if (this.isFoldHorizontal) {
                ...
                return { "id": 67109064, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" };
            }
        }
        return { "id": 67109063, "type": 10002, params: [], "bundleName": "com.huawei.multicommunityapplication", "moduleName": "phone" };
    }
    rerender() {
